...
//                .usingColumns("item_name", "price", "quantity") // 생략 가능
    ...
    public Optional<Item> findById(Long id) {
        ...
        try {
            ...
            Item item = jdbcTemplate.queryForObject(sql, param, itemRowMapper()); // queryForObject : 결과 row가 하나일 때
    ...
    public List<Item> findAll(ItemSearchCond cond) {
        ...
        return jdbcTemplate.query(sql, param , itemRowMapper()); // 쿼리 결과가 여러개 일 때
    }
